...
urlpatterns = [
    ...
    path('categorias/delete/<int:pk>',CategoriaDel.as_view(), name='categoria_edit'),

    path('subcategorias/',SubcategoriaView.as_view(), name='subcategoria_list'),
    path('subcategorias/new',SubCategoriaNew.as_view(), name='subcategoria_list'),
    path('subcategorias/edit/<int:pk>',SubCategoriaEdit.as_view(), name='subcategoria_edit'),
    path('subcategorias/delete/<int:pk>',SubCategoriaDel.as_view(), name='subcategoria_edit'),
